      ...
      <footer className="bg-foreground text-background py-16">
        <div className="container-wide">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            {/* Main Pages */}
            <div>
              <h3 className="font-bold text-background mb-4">Main Pages</h3>
            ...
            {/* Assessments */}
            <div>
              <h3 className="font-bold text-background mb-4">Assessments</h3>
              <ul className="space-y-3">
            ...
            {/* Account & Legal */}
            <div>
              <h3 className="font-bold text-background mb-4">Account & Legal</h3>
              <ul className="space-y-3">
