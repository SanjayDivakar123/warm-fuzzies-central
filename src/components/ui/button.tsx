  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white hover:shadow-glow shadow-colorful border-0 font-bold",
        primary: "bg-gradient-primary text-white hover:shadow-blue shadow-elegant",
        yellow: "bg-gradient-yellow text-yellow-foreground hover:shadow-yellow shadow-soft",
        red: "bg-gradient-red text-red-foreground hover:shadow-red shadow-soft",
        green: "bg-gradient-green text-green-foreground hover:shadow-green shadow-soft",
        blue: "bg-gradient-blue text-blue-foreground hover:shadow-blue shadow-soft",
