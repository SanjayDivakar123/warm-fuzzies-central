...
export const Header = ({
  ...
  return (
    <motion.div
      ...
      className="mx-auto -mt-[232px] max-w-5xl text-center md:-mt-[292px]"
    >
      {titleComponent}
    </motion.div>
  );
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="mx-auto -mt-8 h-[30rem] w-full max-w-5xl rounded-[30px] border-4 border-[#6C6C6C] bg-[#222222] p-2 shadow-2xl md:mt-28 md:h-[40rem] md:p-6 lg:mt-20"
    >
