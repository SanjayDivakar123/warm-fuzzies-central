...
async function sendInviteEmail(
  ...
  const emailContent = {
    personalizations: [
      {
        to: [{ email }],
        subject: `Reminder: Take your Role Color Assessment for ${companyName}`,
      },
    ],
    from: {
        ...
        value: `
          ...
          <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 12px 12px;">
              <h2 style="color: #333; margin-top: 0;">Reminder: Complete your assessment</h2>
              
              <p>Hi there,</p>
              
              <p>This is a reminder that <strong>${companyName}</strong> has invited you to take the Role Color Assessment. Don't miss out on discovering your work style!</p>
              ...
              <p style="color: #999; font-size: 12px; text-align: center; margin: 0;">
                This reminder was sent by ${companyName} through Role Color Finder.<br>
